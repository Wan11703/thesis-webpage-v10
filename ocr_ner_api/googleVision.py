...
app.add_middleware(
    ...
    allow_origins=["https://thesis-webpage-v10-production.up.railway.app",  
                   "https://thesis-webpage-v10-production-775f.up.railway.app"],  # Replace with your frontend's URL
...
def save_extracted_medicines_to_json(extracted_medicine_names):
    ...
    try:
        response = requests.post("https://thesis-webpage-v10-production-c1fa.up.railway.app/process-image", json={"medicineArray": extracted_medicine_names}) # GOOGLE_VISION API
        if response.status_code == 200:
